  ...
  Cropper.prototype = {
    ...
    preview: function () {
      ...
      this.$preview.each(function () {
        var $this = $(this),
        	ratio_height = $this.height() / dragger.height,
            ratio_width = $this.width() / dragger.width;//调整预览缩放比例

        $this.find("img").css({
          width: round(width * ratio_width),
          height: round(height * ratio_height),
          marginLeft: -round(left * ratio_width),
          marginTop: -round(top * ratio_height)
        });
      });
    },
...
//  })('<0 6="5-container"><0 6="5-canvas"></0><0 6="5-dragger"><1 6="5-viewer"></1><1 6="5-8 8-h"></1><1 6="5-8 8-v"></1><1 6="5-face" 3-2="all"></1><1 6="5-7 7-e" 3-2="e"></1><1 6="5-7 7-n" 3-2="n"></1><1 6="5-7 7-w" 3-2="w"></1><1 6="5-7 7-s" 3-2="s"></1><1 6="5-4 4-e" 3-2="e"></1><1 6="5-4 4-n" 3-2="n"></1><1 6="5-4 4-w" 3-2="w"></1><1 6="5-4 4-s" 3-2="s"></1></0></0>', "div,span,directive,data,point,cropper,class,line,dashed");
