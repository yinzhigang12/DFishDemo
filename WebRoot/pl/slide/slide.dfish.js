...
{ "type": "slide", "id": "f_slide0", "width": "470", height: 540, "thumbwidth": 80, "thumbheight": 60, "bigwidth": 470, "bigheight": 470,
  "value": [
...
{ "type": "slide", "id": "f_slide1", "width": "470", height: 470, "bigwidth": 470, "bigheight": 470, "cls": "slide-1",
  "value": [
...
{ "type": "slide", "id": "f_slide2", "width": "470", height: 470, "bigwidth": 470, "bigheight": 470, "cls": "slide-2",
  "value": [
...
{ "type": "slide", "id": "f_slide3", "width": "470", height: 470, "bigwidth": 470, "bigheight": 470, "cls": "slide-3",
  "value": [
...
define.widget( 'slide', {
	Const: function( x, p ) {
		...
		for ( var i = 0, t = [], f = [], g = $.abbr + '.all["' + this.id + '"]', s, v = x.value, l = v && v.length; i < l; i ++ ) {
			...
			f.push( { type: 'html', cls: 'w-slide-big', id: this.id + 'i' + i, width: '*', height: '*', text: s } );
		}
		this.tab = this.add( { type: 'buttonbar', cls: 'w-slide-bbr', width: '*', height: '*', focusable: true, pub: { name: this.id + 'name', cls: 'w-slide-btn' }, nodes: t, on: { mouseout: g + '.play()' } } );
